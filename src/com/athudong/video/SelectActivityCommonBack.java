...
public class SelectActivityCommonBack implements OnClickListener{
	...
	public SelectActivityCommonBack(BaseActivity act, boolean isCreatemainActivity){
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				String path = SelectActivityCommonBack.this.act.getTestPath();
				Bitmap b01  = SelectActivityCommonBack.this.act.readBitmapAutoSize(path+users.get(0).getId()+"_head.jpg", width, height);
				Bitmap b02  = SelectActivityCommonBack.this.act.readBitmapAutoSize(path+users.get(1).getId()+"_head.jpg", width, height);
				Bitmap b03  = SelectActivityCommonBack.this.act.readBitmapAutoSize(path+users.get(2).getId()+"_head.jpg", width, height);
				Bitmap b04  = SelectActivityCommonBack.this.act.readBitmapAutoSize(path+users.get(3).getId()+"_head.jpg", width, height);
