 ...
 * 圆环2
 */
public class RingView02 extends View {
	...
	public RingView02(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		this.context = context;
		this.paint = new Paint();
		this.res = context.getResources();
		this.paint.setAntiAlias(true); // 消除锯齿
		this.ringWidth = dip2px(context, 8); // 设置圆环宽度
	...
	public RingView02(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RingView02(Context context) {
		this(context, null);
	}
