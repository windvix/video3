 ...
 * 
 */
public class RingView03 extends View {
	...
	public RingView03(Context context, AttributeSet attrs, int defStyle) {
		...
		this.ringColor = Color.GRAY;// 黑色进度条背景
		this.progressColor = Color.GRAY;// 白色进度条
		this.textColor = Color.WHITE;// 黑色数字显示进度;
		this.textSize = 25;// 默认字体大小
	}

	public RingView03(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RingView03(Context context) {
		this(context, null);
	}
