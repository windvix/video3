...
public class RingView01 extends View {
	...
	public RingView01(Context context, AttributeSet attrs, int defStyle) {
	...
	public RingView01(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public RingView01(Context context) {
		this(context, null);
	}
